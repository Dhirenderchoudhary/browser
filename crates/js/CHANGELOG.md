...
- *(dom)* implement innerText/outerText getter and setters ([#50](https://github.com/Dhirenderchoudhary/browser/pull/50))
...
- *(js)* expose createRange on all documents ([#49](https://github.com/Dhirenderchoudhary/browser/pull/49))
- *(js)* scope Node.contains to its tree ([#48](https://github.com/Dhirenderchoudhary/browser/pull/48))
- *(js)* enforce dispatchEvent contract ([#45](https://github.com/Dhirenderchoudhary/browser/pull/45))
- *(dom)* implement ParentNode.childElementCount ([#43](https://github.com/Dhirenderchoudhary/browser/pull/43))
- *(js)* canonicalize DOM node wrappers so identity is stable ([#12](https://github.com/Dhirenderchoudhary/browser/pull/12))
- *(js)* stable node identity for arena documents and doctype ([#11](https://github.com/Dhirenderchoudhary/browser/pull/11))
