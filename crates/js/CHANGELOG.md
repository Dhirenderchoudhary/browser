...
- *(dom)* implement ARIA element reflection (aria*Element/aria*Elements) ([#68](https://github.com/Dhirenderchoudhary/browser/pull/68))
- *(dom)* implement Range.prototype.cloneContents ([#65](https://github.com/Dhirenderchoudhary/browser/pull/65))
- *(dom)* implement Selection API and live Range mutations ([#62](https://github.com/Dhirenderchoudhary/browser/pull/62))
- *(dom)* implement XMLDocument for createDocument and fix QName validation ([#61](https://github.com/Dhirenderchoudhary/browser/pull/61))
- *(sw)* implement the Service Worker API ([#56](https://github.com/Dhirenderchoudhary/browser/pull/56)) ([#57](https://github.com/Dhirenderchoudhary/browser/pull/57))
- *(fetch)* support FormData bodies and fix Request URL percent-encoding ([#54](https://github.com/Dhirenderchoudhary/browser/pull/54))
...
- *(html/dom)* implement document named properties ([#125](https://github.com/Dhirenderchoudhary/browser/pull/125))
...
- *(url)* coerce reflected URLs to USVString ([#84](https://github.com/Dhirenderchoudhary/browser/pull/84))
- *(html)* reflect hyperlink username and password ([#82](https://github.com/Dhirenderchoudhary/browser/pull/82))
- *(dom)* make Document.body live and settable ([#81](https://github.com/Dhirenderchoudhary/browser/pull/81))
- *(dom)* add WebKit event handler aliases ([#79](https://github.com/Dhirenderchoudhary/browser/pull/79))
- *(dom)* initialize StaticRange constructor ([#71](https://github.com/Dhirenderchoudhary/browser/pull/71))
- *(url)* don't add spurious // authority to non-special-scheme URLs ([#69](https://github.com/Dhirenderchoudhary/browser/pull/69))
- *(dom)* initialize Text and Comment constructors ([#67](https://github.com/Dhirenderchoudhary/browser/pull/67))
- *(dom)* make NodeIterator/TreeWalker spec-compliant ([#63](https://github.com/Dhirenderchoudhary/browser/pull/63))
- *(dom)* throw required DOMExceptions for Range/Node operations ([#53](https://github.com/Dhirenderchoudhary/browser/pull/53))
- *(js)* implement live DOM collections ([#52](https://github.com/Dhirenderchoudhary/browser/pull/52))
