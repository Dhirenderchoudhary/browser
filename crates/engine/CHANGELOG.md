...
## [0.2.0](https://github.com/Dhirenderchoudhary/browser/compare/v0.0.0...v0.2.0) - 2026-07-27

### Added

- *(engine)* support nested scroll containers
- *(perf)* Navigation Timing 2 + iframe/object navigation infrastructure ([#120](https://github.com/Dhirenderchoudhary/browser/pull/120))
- *(svg)* SVG IDL conformance — idlharness.window.html to 100% ([#119](https://github.com/Dhirenderchoudhary/browser/pull/119))
...
- *(cookies)* shared jar with prefix/Secure/SameSite rules and window.open contexts ([#117](https://github.com/Dhirenderchoudhary/browser/pull/117))
...
- *(css)* pass all css/CSS2/positioning via scroll-clamp, text-indent, inline static position, and @font-face web fonts ([#107](https://github.com/Dhirenderchoudhary/browser/pull/107))
- *(layout)* CSS floats plus Wikipedia rendering and cascade-perf fixes ([#105](https://github.com/Dhirenderchoudhary/browser/pull/105))
- *(dom)* CharacterData methods, CDATASection, and arena-backed off-documents ([#3](https://github.com/Dhirenderchoudhary/browser/pull/3))
- *(engine)* add JPEG XL (.jxl) image decoding ([#4](https://github.com/Dhirenderchoudhary/browser/pull/4))
...
- *(engine)* scale page layout by the backing scale on HiDPI/Retina ([#88](https://github.com/Dhirenderchoudhary/browser/pull/88))
...
- split monolithic lib.rs files into focused modules ([#59](https://github.com/Dhirenderchoudhary/browser/pull/59))
- green up the cross-platform matrix (exclude ffi on Linux/Windows; clippy 1.96) ([#2](https://github.com/Dhirenderchoudhary/browser/pull/2))
