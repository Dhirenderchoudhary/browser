...
## [0.2.0](https://github.com/Dhirenderchoudhary/browser/compare/v0.1.0...v0.2.0) - 2026-07-27
...
- *(layout)* use grid-area containing blocks for abspos grid children ([#115](https://github.com/Dhirenderchoudhary/browser/pull/115))
...
- run cargo test on PRs (Linux only) ([#86](https://github.com/Dhirenderchoudhary/browser/pull/86))
