...
## [0.2.0](https://github.com/Dhirenderchoudhary/browser/compare/v0.0.2...v0.2.0) - 2026-07-27

### Added

- *(cookies)* Cookie Store API + assorted WPT fixes (cookiestore 0 → 70/74) ([#123](https://github.com/Dhirenderchoudhary/browser/pull/123))
...
- *(wpt)* run conformance via real wpt serve + WebDriver (like other browsers) ([#80](https://github.com/Dhirenderchoudhary/browser/pull/80))
...
- *(net)* preserve post-redirect final_url across disk-cache hits ([#109](https://github.com/Dhirenderchoudhary/browser/pull/109))
